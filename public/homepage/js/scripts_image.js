$(window).load(function() {
    ...
    function hidePreloader() {
        ...
        preloader.delay(preloaderDelay).fadeOut(preloaderFadeOutTime, function() {
        	...
        	setTimeout ( function () {
        		$('link[rel=stylesheet][href~="/homepage/css/animate.css"]').remove();
    		},2000);
         });
    }
...
$(document).ready(function(){
	...
	if (navigator.userAgent.search("MSIE") >= 0) {
		$('head').append('<link rel="stylesheet" type="text/css" media="screen" href="/homepage/css/ie.css">');
	}
	...
	if( !device.tablet() && !device.mobile() ) { //Load the animations if the device is not a mobile or tablet
		$('head').append('<!--[if !IE]><!--><link rel="stylesheet" type="text/css" media="screen" href="/homepage/css/animate.css"><!--<![endif]-->');
	}
	...
	=============================================== */
	var now = new Date();
	var dateFinal = new Date('2015','02','24','00','00','00'); // new Date( year , month , day , hour , minutes , seconds)
